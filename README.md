...
- *I tried to create monitoring for Docker. It's really cool. I created 3 docker containers on Prometheus servers: Grafana, Nodexporter agent, and also created similar docker agents on different nodes.*
